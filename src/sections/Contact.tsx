    ...
    <main className="container max-w-5xl px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="mx-auto space-y-4 flex flex-col">
        ...
        <button
          ...
          className="self-center w-full sm:max-w-[40%] min-w-unset sm:min-w-300px h-14 p-2 rounded-xl border font-calli text-3xl bg-[#f0ebe3] hover:bg-[#d9cfc0]  border-[#e0dcd5] focus:ring-[#e0dcd5] text-gray-800 transition focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50"
        >
